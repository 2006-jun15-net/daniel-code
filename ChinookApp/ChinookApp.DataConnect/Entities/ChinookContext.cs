        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Department>(entity =>
            {
                entity.HasKey(e => e.DeptId)
                    .HasName("PK__Departme__0148818E9D89BEBE");
            ...
            modelBuilder.Entity<EmpDetails>(entity =>
            {
                ...
                entity.HasOne(d => d.Employee)
                    ...
                    .HasConstraintName("FK__EmpDetail__Emplo__6E01572D");
            });
            ...
            modelBuilder.Entity<Employees>(entity =>
            {
                entity.HasKey(e => e.EmployeeId)
                    .HasName("PK__Employee__7AD04FF1E1A09741");
                ...
                entity.HasOne(d => d.Dept)
                    ...
                    .HasConstraintName("FK__Employees__DeptI__6B24EA82");
            });
